...
<?php require($path . 'templates/header.php') ?>
	<div class="container-fluid my-4">
        ...
        <td>
					<a href="useredit.php?id=<?php echo $r['userID']; ?>"><button type="button" class="btn btn-info">Edit</button></a>
					    ...
					    <div class="modal-dialog">
					      ...
					      <div class="modal-content">
					        ...
					        <div class="modal-footer">
					          ...
					          <a href="deleteuser.php?id=<?php echo $r['userID']; ?>"><button type="button" class="btn btn-danger"> Yes, Delete</button></a>
					        </div>
					      </div>
